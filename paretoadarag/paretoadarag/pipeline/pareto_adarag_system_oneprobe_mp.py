...
class ParetoAdaRAGSystemOneProbeMP:
    def __init__(
        self,
        *,
        light_retriever,
...
def build_system_from_cfg(cfg: dict, *, judge_enabled: bool) -> ParetoAdaRAGSystemOneProbeMP:
    ...
    return ParetoAdaRAGSystemOneProbeMP(
...
ParetoAdaRAGSystemTriProbeMP = ParetoAdaRAGSystemOneProbeMP
